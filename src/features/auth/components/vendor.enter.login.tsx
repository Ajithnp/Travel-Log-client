    ...
    <div className="bg-muted flex min-h-svh flex-col items-center justify-center p-6 md:p-10">
      <div className="w-full max-w-sm md:max-w-3xl">
        ...
        >
          ...
          >
            Share your business with thousands of customers. Join our marketplace and grow your reach today.
          </motion.p>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-3 bg-card p-4 rounded-lg border">
            ...
            <span className="text-sm text-card-foreground">Reach More Customers</span>
          </div>
          <div className="flex items-center gap-3 bg-card p-4 rounded-lg border">
            <TrendingUp className="h-5 w-5 text-gray-900" />
            <span className="text-sm text-card-foreground">Boost Your Sales</span>
          </div>
          <div className="flex items-center gap-3 bg-card p-4 rounded-lg border">
            <Store className="h-5 w-5 text-gray-900" />
            <span className="text-sm text-card-foreground">Manage Inventory</span>
          </div>
        </motion.div>
