            ...
            <form onSubmit={handleOtpSubmit}>
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-col gap-4 items-center">
                        ...
                        <Button type="submit" className="w-full" variant={"stunnung"} disabled={timer <= 0}>
                            {buttonText}
                        </Button>
                    ...
                    <div className="flex justify-between relative ">
                        ...
                        <Button className="flex  text-blue cursor-pointer rounded" variant={'link'} disabled = {timer > 0 || isLoading } onClick={resendOTP}>
                            resend otp
                        </Button> */}
                        {timer > 0 ? <span>{timer} seconds</span> : <Button type='button' className="flex text-blue cursor-pointer rounded" variant={'link'} disabled={timer > 0 || isLoading} onClick={resendOTP}>
                            Resend OTP
                        </Button>}
                    </div>
