...
import type { PackageDetailWithStats, IPackage, PackageScheduleContextResponse} from "../type/package";
...
export const getPackagesWithId = async <T = PackageDetailWithStats>(
  packageId: string,
