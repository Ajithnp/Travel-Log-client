...
const slideContent = [
  {
    image: assets.vendorSlide1,
    title: "Create Unique Travel Packages",
    description:
      "Design and publish travel experiences for explorers around the world. Turn your ideas into curated trips that travelers can easily discover and book.",
  },
  {
    image: assets.vendorSlide2,
    title: "Grow Your Travel Business",
    description:
      "Reach a wider audience, manage your tour schedules, and build your travel brand with tools designed for professional trip organizers.",
  },
  {
    image: assets.vendorSlide3,
    title: "Connect with Travelers",
    description:
      "Showcase your destinations, attract new customers, and help people discover unforgettable journeys through your expertly crafted packages.",
  },
];
