...
//     // Button label changes based on split
...
//       return `Pay ₹${split.stripeAmount.toLocaleString('en-IN')} via Stripe →`;
//     }
//     return (
...
//               <Wallet2 className="w-4 h-4" /> Available Wallet Balance
//             </h3>
//           </div>
...
//                     {' + '}₹{split.stripeAmount.toLocaleString('en-IN')} via Stripe
//                   </p>
//                 )}
//                 {useWallet && split.method === 'wallet' && (
//                   <p className="text-xs text-green-600 mt-0.5 font-medium">
//                     ✓ Full amount covered — no Stripe needed
//                   </p>
//                 )}
//               </div>
