        ...
        {tabs?.map((tab) => {
          ...
          return (
            <Button
              ...
              className={`relative px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-300 flex items-center gap-2 outline-none cursor-pointer bg-gradient-to-r ${gradient} ${isActive
                  ? "text-foreground"
            ...
            >
              ...
              <span
                className={`relative z-10 text-[10px] px-2 py-0.5 rounded-full font-bold transition-colors ${isActive
